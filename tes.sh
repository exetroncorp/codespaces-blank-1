...
qrap 5 kvm -m 2048 -nic user,model=virtio  -smp 2 -cpu qemu64 -accel tcg,thread=multi -net socket,fd=5 -net nic,model=virtio  -drive file=alpine.raw,if=virtio,format=raw -nographic
